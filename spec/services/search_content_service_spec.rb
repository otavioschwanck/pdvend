...
RSpec.describe SearchContentService, type: :service do
  describe '.search' do
    before(:each) do
      ...
      create(:link, url: 'https://www.youtube.com.br/')
      create(:link, url: 'https://www.google.com.br/')
      ...
      WebMock.stub_request(:get, 'https://www.youtube.com.br/')
             .to_return(body: 'NOVO PROGRAMADOR DA PDVEND: Otavio <3')

      WebMock.stub_request(:get, 'https://www.google.com.br/')
    ...
    it 'return all sites that contains pdvend' do
      ...
      expect(service.search).to eq(['https://www.pdvend.com.br/', 'https://www.ubuntu.com/',
                                    'https://www.youtube.com.br/'].to_json)
    end
  end
end
